...
ItemList = []
SupremeLinks = ['jackets', 'shirts', 'tops_sweaters', 'pants', 'shorts', 'bags', 'hats', 'accessories', 'shoes', 'skate']
			...
			if(index != -1):
				...
				if(SoldOut != oldSoldOut):
					if(not SoldOut):
						...
						SendDiscordMessage(ItemName, ItemColor, oldPrice, 'Sold Out', ItemLink, ItemPicture, oldSizes, webhook)
					ItemList.pop(index)
