...
if path.exists('darkside_list.dat'):
    filehandler = open('darkside_list.dat', 'rb')
...
def SendDiscordMessage(itemName, itemColor, price, availability, URL, imageURL, sizes, webhook):
    Desc = '**Shop:** [The Darkside Initiative (US)](https://www.thedarksideinitiative.com/collections/footwear/)\n**Price:** ' + price + '\n**State:** ' + availability + '\n\n> QuickTask\n> [' + sizes + '](' + URL + ')';
    Color = 12726577
    Footer = '[SneakerAlpha]'
...
while True:
    time.sleep(10)
    pageNum += 1
    request = requests.get('https://www.thedarksideinitiative.com/collections/footwear/products.json?limit=250&page=' + str(pageNum))
    ...
    for product in decodedJson['products']:
        ...
        ItemLink = 'https://www.thedarksideinitiative.com/collections/footwear/products/' + product['handle']
    ...
    file = open('darkside_list.dat', 'wb')
