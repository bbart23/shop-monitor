...
if path.exists('rockcity_list.dat'):
    filehandler = open('rockcity_list.dat', 'rb')
...
def SendDiscordMessage(itemName, itemColor, price, availability, URL, imageURL, sizes, webhook):
    Desc = '**Shop:** [Rock City Kicks (US)](https://rockcitykicks.com/collections/sn/)\n**Price:** ' + price + '\n**State:** ' + availability + '\n\n> QuickTask\n> [' + sizes + '](' + URL + ')';
    Color = 12726577
    Footer = '[SneakerAlpha]'
...
while True:
    time.sleep(10)
    pageNum += 1
    request = requests.get('https://rockcitykicks.com/collections/sn/products.json?limit=250&page=' + str(pageNum))
    ...
    for product in decodedJson['products']:
        ...
        ItemLink = 'https://rockcitykicks.com/collections/sn/products/' + product['handle']
    ...
    file = open('rockcity_list.dat', 'wb')
